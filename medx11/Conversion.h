...
namespace medx11
{
	...
	T_To Cast(T_From from);

	template<>
	inline
		DXGI_FORMAT Cast(me::render::Format::TYPE format)
	{
	...
	template<>
	inline
	me::render::Format::TYPE Cast(DXGI_FORMAT format)
	{
		using namespace me::render;
		switch (format)
		{
	...
	template<>
	inline
	D3D11_USAGE Cast(me::render::BufferUsage::TYPE usage)
	{
		using namespace me::render;
	...
	template<>
	inline
	me::render::BufferUsage::TYPE Cast(D3D11_USAGE usage)
	{
		using namespace me::render;
